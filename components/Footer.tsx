    ...
    <footer className="footer flex flex-col bg-[#0D2000] text-white border-t-2 border-gray-300 gap-0">
      <div className="container mx-auto flex flex-col md:flex-row gap-0 justify-between p-6 md:p-10">
        ...
        <div className="w-full md:w-1/4 mb-8 text-left pl-1 md:pl-8">
          ...
          <div className="flex justify-start md:justify-start space-x-4 my-4">
            ...
            <a href="https://www.instagram.com/eazetourpackages/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-600 transition-colors">
              <span className="relative w-7 h-7 flex items-center justify-center rounded-full bg-white text-black hover:bg-gray-300"><i className="fab fa-instagram text-lg leading-lg" /></span>
            </a>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 pl-1 md:pl-[80px] md:pt-[40px]">
          ...
          <ul className="space-y-4">
            <li><Link href="/packages" className="hover:text-blue-600 transition-colors">Delhi</Link></li>
            <li><Link href="/packages" className="hover:text-blue-600 transition-colors">Jaipur</Link></li>
            <li><Link href="/packages" className="hover:text-blue-600 transition-colors">Agra</Link></li>
            <li><Link href="/packages" className="hover:text-blue-600 transition-colors">Varanasi</Link></li>
            <li><Link href="/packages" className="hover:text-blue-600 transition-colors">Goa</Link></li>
          </ul>
        </div>
