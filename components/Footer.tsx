  ...
  return (
    <footer className="footer flex flex-col bg-[#0D2000] text-white border-t-2 border-gray-300 gap-0">
      ...
      <p className="text-sm mt-2 mb-4">Established in 2015, Eaze Tours is driven by three travel professionals, with decades of combined varied experience in the tour industry.</p>
        ...
        <div className="w-full md:w-1/4 mb-8 pl-1 md:pl-[80px] md:pt-[40px]">
          ...
          <ul className="space-y-4">
            <li><Link href="/about" className="hover:text-[#6e9753] transition-colors">About us</Link></li>
            <li><Link href="/contact" className="hover:text-[#6e9753] transition-colors">Contact us</Link></li>
            <li><Link href="/packages" className="hover:text-[#6e9753] transition-colors">Packages</Link></li>
            <li><Link href="/gallery" className="hover:text-[#6e9753] transition-colors">Gallery</Link></li>
            <li><Link href="/testimonials" className="hover:text-[#6e9753] transition-colors">Testimonials</Link></li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 pl-1 md:pl-[80px] md:pt-[40px]">
          ...
          <ul className="space-y-4">
            <li><Link href="/packages/28" className="hover:text-[#6e9753] transition-colors">Delhi</Link></li>
            <li><Link href="/packages/34" className="hover:text-[#6e9753] transition-colors">Jaipur</Link></li>
            <li><Link href="/packages/35" className="hover:text-[#6e9753] transition-colors">Agra</Link></li>
            <li><Link href="/packages/21" className="hover:text-[#6e9753] transition-colors">Varanasi</Link></li>
            <li><Link href="/packages/16" className="hover:text-[#6e9753] transition-colors">Goa</Link></li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 pl-1 md:pl-8 md:pt-[40px]">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-2">
              ...
              <div>
                <p className="text-sm"><a href="tel:+919873186168" className="hover:text-[#6e9753]">+91 98731 86168</a></p>
                <p className="text-sm"><a href="tel:+919911684818" className="hover:text-[#6e9753]">+91 99116 84818</a></p>
              </div></div>
            <div className="flex items-start space-x-2">
              <i className="far fa-envelope text-lg text-white-400 -mt-1" />
              <div>
                <p className="text-sm"><a href="mailto:info@eazetours.com;harshit@eazetours.com" className="hover:text-[#6e9753]">info@eazetours.com</a></p>
                <p className="text-sm"><a href="mailto:harshit@eazetours.com" className="hover:text-[#6e9753]">harshit@eazetours.com</a></p>
              </div>
            </div>
            <div className="flex items-start space-x-2">
      ...
      <div className="w-full bg-[#0D2000] text-white py-7 text-center justify-center border-t border-white border-opacity-50">
        <p className="text-sm">&copy; Copyright <a href="/" className="hover:text-[#6e9753]">Eaze Tours</a> 2024. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
