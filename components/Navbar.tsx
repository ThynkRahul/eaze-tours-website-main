                ...
                <div className="flex justify-between items-center text-xs md:text-sm w-full max-w-screen-xl">
                    ...
                    <div className="flex gap-4">
                        <span className="flex items-center gap-2">
                            ...
                            <a href="tel:+919873186168" className="text-white text-[16px] hover:text-[#025c7a]-600">+91 987 318 6168</a>
                        </span>
                        <span className="flex items-center gap-2">
                            <i className="fas fa-envelope text-[18px]" />
                            <span className="flex flex-wrap">
                                <a href="mailto:info@eazetours.com" className="text-white text-[16px] hover:text-[#025c7a]-600">info@eazetours.com</a>
                                <a href="mailto:harshit@eazetours.com" className="text-white text-[16px] hover:text-[#025c7a]-600 ml-1">, harshit@eazetours.com</a>
                            </span>
                        </span>
                    </div>
                    {/* Social Icons */}
