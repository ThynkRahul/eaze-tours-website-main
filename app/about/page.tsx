    ...
    <>
      <div className="mt-[135px] sm:mt-[165px] mx-8 mb-12">
        <p className="text-[14px] text-gray-700 mt-4">
          <span className="text-[#ccc] hover:text-[#035C7A]"><Link href="/" passHref>Home</Link></span> / About us
        </p>
      ...
      <div className="bg-[#025C7A] flex flex-col sm:flex-row py-[100px] text-[#fff] justify-center items-center">
        <div className="w-[90%] sm:w-[50%] mx-8"><h3 className="text-[32px] sm:text-[50px] font-semibold mb-4 capitalize font-urbanist leading-[1.2em]">Finding your dream destination is our priority</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-[90%] sm:w-[50%] mx-8">
          <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] sm:aspect-sqaure rounded-lg flex flex-col items-left justify-center">
      ...
      <div className="flex flex-col py-[100px] text-[#fff] bg-[#025C7A] justify-center items-center">
        <div className="mx-auto mb-12 w-[90%] sm:w-[45%]">
          <h2 className="text-[32px] sm:text-[42px] font-semibold capitalize text-center leading-[1.2em] mb-4">
