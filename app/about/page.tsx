    ...
    <>
      ...
      <div className="bg-[#025C7A] flex flex-col sm:flex-row py-[100px] text-[#fff] justify-center items-center">
        <div className="w-[90%] sm:w-[50%] mx-8">
          <h3 className="text-[32px] sm:text-[50px] font-semibold mb-4 capitalize font-urbanist leading-[1.2em]">Finding your dream destination is our priority</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-[90%] sm:w-[50%] mx-8">
          <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] sm:aspect-square rounded-lg flex flex-col items-left justify-center">
