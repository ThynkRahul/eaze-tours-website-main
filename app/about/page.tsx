  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8 sm:flex-row py-[100px] text-[#000] justify-center items-center">
        ...
        <div className="mx-8 sm:w-[40%]">
          <h3 className="text-[28px] sm:text-[50px] font-semibold mb-4 capitalize font-urbanist leading-[1.2em]">
            About Us
          </h3>
          <p className="mb-4 font-urbanist text-[#000] font-semibold">
      ...
      <div className="bg-[#025C7A] flex flex-col sm:flex-row py-[70px] text-[#fff] justify-center items-center">
        <div className="w-[90%] sm:w-[50%] mx-8">
          <h3 className="text-[32px] sm:text-[50px] font-semibold mb-4 capitalize font-urbanist leading-[1.2em]">Your Dream Destination Awaits – We Make It Happen!</h3>
        ...
        <div className="w-[90%] sm:w-[50%] mx-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] rounded-lg flex flex-col items-left justify-center">
              ...
              <h2 className="info-heading text-2xl font-urbanist font-medium text-black text-left mt-4 mb-2">Handpicked Luxury Stays</h2>
            ...
            <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] rounded-lg flex flex-col items-left justify-center">
              ...
              <h2 className="info-heading text-2xl font-urbanist font-medium text-black text-left mt-4 mb-2">Personalized Travel Itineraries</h2>
              <p className="info-content text-left text-[#4F5E71] font-[16px] leading-[19px]">
            ...
            <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] rounded-lg flex flex-col items-left justify-center">
              ...
              <h2 className="info-heading text-2xl font-urbanist font-medium text-black text-left mt-4 mb-2">Exclusive Experiences</h2>
              <p className="info-content text-left text-[#4F5E71] font-[16px] leading-[19px]">
            ...
            <div className="info-box bg-[#fff] p-4 w-full aspect-[4/3] rounded-lg flex flex-col items-left justify-center">
              ...
              <h2 className="info-heading text-2xl font-urbanist font-medium text-black text-left mt-4 mb-2">Authentic Cultural Experiences</h2>
              <p className="info-content text-left text-[#4F5E71] font-[16px] leading-[19px]">
      ...
      <div className="flex flex-col py-[100px] text-[#fff] bg-[#025C7A] justify-center items-center">
        <div className="mx-auto mb-12">
          ...
          <p className="text-md mt-1 text-center w-[90%] sm:w-[90%] mx-auto">
        ...
        <div className="gallery-container mx-8 w-[90%] ">
      ...
      <div className={`info-container flex flex-col sm:flex-row justify-center gap-12 my-[70px] max-w-screen-xl mx-8 flex-wrap sm:flex-nowrap`}>
        <div className="info-box p-0 rounded-lg w-[100%] flex flex-col items-center sm:w-[33%]">
          ...
          <h2 className="info-heading text-[30px] font-urbanist font-medium text-black text-center mt-4">Email</h2>
        ...
        <div className="info-box p-0 rounded-lg w-[100%] flex flex-col items-center sm:w-[33%]">
          ...
          <h2 className="info-heading text-[30px] font-urbanist font-medium text-black text-center mt-4">Phone</h2>
        ...
        <div className="info-box p-0 rounded-lg w-[100%] flex flex-col items-center sm:w-[33%]">
          ...
          <h2 className="info-heading text-[30px] font-urbanist font-medium text-black text-center mt-4">Location</h2>
